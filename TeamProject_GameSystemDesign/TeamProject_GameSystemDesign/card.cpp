...
bool Card::CreateMergedCard(Card& other, Card& result) {
    if ((type == WIDTH_TYPE && other.type == LENGTH_TYPE) || (type == LENGTH_TYPE && other.type == WIDTH_TYPE)) {
        ...
        result = PurificationCrossCard();
        return true;
    }
    else if ((type == SQUARE_TYPE && other.type == SQUARE_TYPE)) {
        result = UpgradeSquareCard();
        return true;
    }
...
{
    area.push_back({ 0,0, 100 });
    area.push_back({ 1,0 , 85 });
    area.push_back({ 2,0 , 70 });
    area.push_back({ 3,0 , 55 });
    area.push_back({ 4,0 , 40 });
    area.push_back({ 5,0 , 25 });
    area.push_back({ 6,0 , 10 });
    area.push_back({ -1,0 , 85 });
    area.push_back({ -2,0 , 70 });
    area.push_back({ -3,0 , 55 });
    area.push_back({ -4,0 , 40 });
...
{
    area.push_back({ 0,0, 100 });
    area.push_back({ 0,1 , 85 });
    area.push_back({ 0,2 , 70 });
    area.push_back({ 0,3 , 55 });
    area.push_back({ 0,4 , 40 });
    area.push_back({ 0,5 , 25 });
    area.push_back({ 0,6 , 10 });
    area.push_back({ 0,-1 , 85 });
    area.push_back({ 0,-2 , 70 });
    area.push_back({ 0,-3 , 55 });
    area.push_back({ 0,-4 , 40 });
...
{
    area.push_back({ 0,0, 100 });
    area.push_back({ 1,0 , 65 });
    area.push_back({ 1,1 , 65 });
    area.push_back({ 1,-1 , 65 });
    area.push_back({ 0,1 , 65 });
    area.push_back({ 0,-1 , 65 });
    area.push_back({ -1,1 , 65 });
    area.push_back({ -1,0 , 65 });
    area.push_back({ -1,-1 , 65 });
...
UpgradeXCard::UpgradeXCard() : Card(UPGRADE_X_TYPE)
{
    area.push_back({ 0,0, 100 });
    area.push_back({ 1,1 , 100 });
    area.push_back({ 2,2 , 100 });
    area.push_back({ 3,3 , 100 });
    area.push_back({ 4,4 , 100 });
    area.push_back({ -1,-1 , 100 });
    area.push_back({ -2,-2 , 100 });
    area.push_back({ -3,-3 , 100 });
    area.push_back({ -4,-4 , 100 });
